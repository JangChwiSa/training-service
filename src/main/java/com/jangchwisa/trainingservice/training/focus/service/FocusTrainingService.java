...
import com.jangchwisa.trainingservice.training.focus.repository.FocusTrainingRepository.FocusCommandRow;
...
import com.jangchwisa.trainingservice.training.focus.repository.FocusTrainingRepository.ScoredFocusReaction;
    ...
    public CompleteFocusSessionResponse completeSession(
        ...
        TrainingCompletionResult result = trainingCompletionService.complete(new TrainingCompletionCommand(
                ...
                new TrainingCompletionFeedback(
                        ...
                        "SYSTEM",
                        "집중력 훈련을 완료했습니다.",
                        "반응 정확도와 평균 반응 시간을 기준으로 점수를 계산했습니다."
                ),
