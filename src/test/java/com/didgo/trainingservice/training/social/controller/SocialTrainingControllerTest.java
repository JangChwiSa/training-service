...
class SocialTrainingControllerTest {
    ...
    void returnsScenarioListByJobType() throws Exception {
        mockMvc.perform(get("/api/trainings/social/scenarios")
                ...
                .andExpect(jsonPath("$.data[0].title").value("Offer help to a coworker"))
    ...
    void returnsScenarioDetail() throws Exception {
        mockMvc.perform(get("/api/trainings/social/scenarios/1")
                ...
                .andExpect(jsonPath("$.data.jobType").value("OFFICE"))
                .andExpect(jsonPath("$.data.backgroundText").value("Office break room"))
                .andExpect(jsonPath("$.data.situationText").value("A coworker looks upset."));
    }
    ...
    void returnsSessionDetailAfterOwnershipValidation() throws Exception {
        ...
        socialRepository.feedback = Optional.of(new SocialFeedbackResponse("Summary feedback", "Detailed feedback"));
        socialRepository.dialogLogs = List.of(
                new SocialDialogLogResponse(1, SocialDialogSpeaker.USER, "Can you help me?"),
                new SocialDialogLogResponse(1, SocialDialogSpeaker.AI, "Sure. What do you need?")
        );
        ...
        mockMvc.perform(get("/api/trainings/social/sessions/10/detail")
                ...
                .andExpect(jsonPath("$.data.feedback.summary").value("Summary feedback"))
    ...
    static class FakeSocialTrainingRepository implements SocialTrainingRepository {
        ...
        public Optional<SocialScenarioDetailResponse> findActiveScenarioDetail(long scenarioId) {
            return Optional.of(new SocialScenarioDetailResponse(scenarioId, SocialJobType.OFFICE, "Offer help to a coworker", "Office break room", "A coworker looks upset.", "How would you respond?", 1));
        }
